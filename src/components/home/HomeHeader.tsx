...
const HomeHeader = () => {
	...
	return (
		<header className="header lg:flex flex-cols relative">
			...
			<div className="px-[1rem] lg:p-0 w-[21.875rem] mt-[2rem]">
			...
			<Link to={"/location"}>
				<button className="locationButton lg:absolute lg:left-[57.81rem] lg:top-[25.88rem] px-[1rem] lg:p-0 mt-[2rem] lg:m-0 flex group">
